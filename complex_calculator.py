...
#5 use try and except to catch input errors
...
def diff(n1,n2): return(n1 - n2)
    
def prod(n1,n2): return(n1 * n2)
...
def pow(n1,n2): return n1**n2
    
def sqrt(n1): return cmath.sqrt(n1)
...
while True:
    ...
    if 1 <= choice <= 8:
        ...
        elif choice == 2: print(f'difference of {n1} and {n2} is {diff(n1,n2)} ')
        elif choice == 3: print(f'product of {n1} and {n2} is {prod(n1,n2)} ')
        elif choice == 4: print(f'quotient of {n1} and {n2} is {div(n1,n2)} ')
        elif choice == 5: print(f'power of {n1} and {n2} is {pow(n1,n2)} ')
